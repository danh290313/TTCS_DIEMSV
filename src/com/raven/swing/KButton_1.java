 ...
 */
public class KButton_1 extends JButton {
        ...
        if (mousePressed == true) {
            ...
            if (iskAllowTab()) {
                ...
                for (int i = 0; i < comp.length; i++) {
                    if (comp[i] instanceof KButton_1) {

                        ((KButton_1) comp[i]).setSelected(false);
                        ((KButton_1) comp[i]).setBorder(BorderFactory.createMatteBorder(0, 0, 0, 0, kIndicatorColor));
                    }
                }
